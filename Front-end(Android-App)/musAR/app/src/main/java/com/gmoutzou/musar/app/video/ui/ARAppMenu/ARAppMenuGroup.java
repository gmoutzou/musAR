...
public class ARAppMenuGroup
{
    Activity mActivity;
    ARAppMenuInterface mMenuInterface;
    ...
    public ARAppMenuGroup(ARAppMenuInterface menuInterface,
                          Activity context, ARAppMenu parent, boolean hasTitle, String title,
                          int width)
    {
        mActivity = context;
        ...
        mLayout = (LinearLayout) inflater.inflate(
            R.layout.ar_app_menu_group, null, false);
        ...
        dividerResource = R.layout.ar_app_menu_group_divider;
    ...
    public View addRadioItem(String text, int command, boolean isSelected)
    {
        ...
        RadioButton newRadioButton = (RadioButton) inflater.inflate(
            R.layout.ar_app_menu_group_radio_button, null, false);
